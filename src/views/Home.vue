  ...
  <div class="min-h-screen">
    ...
    <section class="bg-white border-b border-gray-200 py-8">
      <div class="container mx-auto px-6">
        <div class="max-w-4xl">
          <div class="mb-4">
            <div class="inline-flex items-center gap-2 bg-green-50 px-3 py-1 rounded-full border border-green-200 mb-4">
              <div class="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
              <span class="text-sm text-green-700">持续更新中</span>
            </div>
          </div>
          ...
          <div class="flex flex-wrap gap-2">
            <span v-for="skill in skills.slice(0, 6)" :key="skill.name" 
                  class="px-3 py-1 bg-gray-100 border border-gray-200 rounded-full text-sm font-medium text-gray-700 hover:bg-gray-200 transition-all duration-200">
    ...
    <section id="featured" class="py-12 bg-white">
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 max-w-2xl mx-auto">最新的技术分享和思考总结</p>
        </div>
          ...
          <article v-for="post in featuredPosts" :key="post.slug" 
            ...
            <div class="aspect-video bg-gradient-to-br from-primary-100 to-secondary-100 relative overflow-hidden">
              ...
              <div class="absolute bottom-4 left-4">
                <span class="px-3 py-1 bg-white/90 backdrop-blur-sm rounded-full text-sm font-medium cursor-pointer hover:bg-white transition-colors" 
            ...
            <div class="p-6">
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center text-primary-600 font-medium group-hover:gap-3 transition-all duration-200">
        ...
        <!-- 如果没有精选文章，显示最新文章 -->
        <div v-if="!loading && !error && featuredPosts.length === 0 && recentPosts.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <section id="projects" class="py-12 bg-gray-50">
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">项目展示</h2>
          <p class="text-xl text-gray-600 max-w-2xl mx-auto">一些有趣的个人项目和开源贡献</p>
        </div>
            ...
            <div class="p-8">
              <div class="flex items-start justify-between mb-6">
                <div class="w-12 h-12 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-xl flex items-center justify-center">
                  <i :class="project.icon" class="text-white text-xl"></i>
                </div>
                <div class="flex gap-2">
                  <a :href="project.github" class="w-8 h-8 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center transition-colors duration-200">
                    <i class="fab fa-github text-gray-600"></i>
                  </a>
                  <a :href="project.demo" class="w-8 h-8 bg-gray-100 hover:bg-gray-200 rounded-lg flex items-center justify-center transition-colors duration-200">
